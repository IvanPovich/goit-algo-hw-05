...
from algotitm_search.boyer_moore_search import boyer_moore_search
from algotitm_search.kmp_search import kmp_search
from algotitm_search.rabin_karp_search import rabin_karp_search

def load_file(file):
  with open(file, 'r', encoding='utf-8', errors='ignore') as f:
    return f.read()

text_1 = load_file('./task_3/стаття1.txt')
text_2 = load_file('./task_3/стаття2.txt')

text1_substring = "public static int binarySearch(int arr[], int elementToSearch)"
text2_substring = "Було проведено 4 серії експериментів. Нижче наведено параметри кожної серії."
